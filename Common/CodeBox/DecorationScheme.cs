    ...
    public class CodeViewHelper : List<Decoration>
    {
        ...
        public static CodeViewHelper Shader
        {
            get
            {
                ...
                ds.Add(new Decoration(CSSyntax.QoutedString, Brushes.Crimson)); // quotedText
                ds.Add(new Decoration(CSSyntax.CppComment, Brushes.Green)); // single line comments
                ds.Add(new Decoration(CSSyntax.CComment, Brushes.Green)); // multiline comments
                return ds;
            }
        }
        public static CodeViewHelper CSharp3
        {
            get
            {
                CodeViewHelper ds = new CodeViewHelper();
                ds.Name = "C#";
                List<string> reservedWords = new List<string>{ "delegate", "using", "namespace", "static", "class", "public", "get", "partial", "private",
                    "return", "partial", "new" , "set", "value", "readonly" };
                ...
                ds.Add(new Decoration(CSSyntax.QoutedString, Brushes.RosyBrown)); // quotedText
                ds.Add(new Decoration(CSSyntax.CComment, Brushes.Green)); // multiline comments
                ds.Add(new Decoration(CSSyntax.CppComment, Brushes.Green)); // single line comments
                return ds;
            }
